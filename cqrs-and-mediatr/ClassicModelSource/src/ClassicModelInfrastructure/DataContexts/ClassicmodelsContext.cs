...
namespace ClassicModelInfrastructure.Contexts;
...
//         => optionsBuilder.UseMySQL("server=localhost;database=classicmodels;user=my_user;password=AqzLpm*67890");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => new { e.OrderNumber, e.ProductCode }).HasName("PRIMARY");
        ...
        {
            entity.HasKey(e => new { e.CustomerNumber, e.CheckNumber }).HasName("PRIMARY");
